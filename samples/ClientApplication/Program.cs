...
static async Task RabbitMQProtocol(IServiceProvider serviceProvider)
{
...
static async Task MemcachedProtocol(IServiceProvider serviceProvider)
{
    var loggerFactory = LoggerFactory.Create(builder =>
    {
        builder.SetMinimumLevel(LogLevel.Error);
...
static async Task HttpClient(IServiceProvider serviceProvider)
{
...
static async Task EchoServerWithTls(ServiceProvider serviceProvider)
{
    var client = new ClientBuilder(serviceProvider)
                            .UseSockets()
                            .UseConnectionLogging()
...
static async Task InMemoryEchoTransport(IServiceProvider serviceProvider)
{
...
static async Task CustomProtocol()
{
    var loggerFactory = LoggerFactory.Create(builder =>
    {
        builder.SetMinimumLevel(LogLevel.Debug);
...
static async Task DockerDaemon(IServiceProvider serviceProvider)
{
    var client = new ClientBuilder(serviceProvider)
